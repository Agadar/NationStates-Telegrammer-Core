...
public class FilterDelegatesNewFinite extends FilterHappeningsFinite {
    ...
    public FilterDelegatesNewFinite(INationStates nationStates, IHistoryManager historyManager, IFilterCache filterCache, int amountToRetrieve) {
        super(nationStates, historyManager, filterCache, KeyWord.became, amountToRetrieve);
    }
