...
public enum RecipientsFilterType {
    ...
    NATIONS_CONTAINING_KEYWORDS("Nations containing specific keywords", RecipientsFilterAction.REMOVE_FROM_RECIPIENTS, "Insert keywords, e.g. 'noob', '420'."),
    NATIONS_IN_EMBASSY_REGIONS("Nations in embassies of specified regions", "Insert region names, e.g. 'region1, region2'."),
    NATIONS_IN_REGIONS_WITH_TAGS("Nations in regions with specified tags", "Insert region tags, e.g. 'tag1, tag2'."),
    NATIONS_IN_REGIONS_WITHOUT_TAGS("Nations in regions without specified tags", "Insert region tags, e.g. 'tag1, tag2'."),
    ...
    private RecipientsFilterType(String text, String inputHint) {
        this(text, !inputHint.isEmpty(), new RecipientsFilterAction[] {
    ...
    private RecipientsFilterType(String text, RecipientsFilterAction supportedAction, String inputHint) {
        this(text, !inputHint.isEmpty(), new RecipientsFilterAction[] { supportedAction }, inputHint);
    }

    private RecipientsFilterType(String text, boolean allowsInput, RecipientsFilterAction[] supportedActions,
            String inputHint) {
        this.text = text;
